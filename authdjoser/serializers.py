...
class UserCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        #         Student.objects.create(user = user,name = (user.first_name))
        #         group = Group.objects.get(name='Student')
        #         user.groups.add(group)
                
        #     else :
        #         Teacher.objects.create(user = user,name = (user.first_name))
...
#         userc = User.objects.create(**validated_data)
        

#         try:
#             Teacher.objects.get(user = userc)


        
#         except:
#             Student.objects.create(user = userc,name = (userc.first_name))
#             group = Group.objects.get(name='Student')
...
#         else:
#             Teacher.objects.create(user = userc)
#             group = Group.objects.get(name='Teacher')
#             userc.groups.add(group)
